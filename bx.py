...
def print_languages_and_popularity(
    list_programming_languages: list, list_popularity: list
):
...
def update_popularity(
    language: str, list_programming_languages: list, list_popularity: list
):
...
def print_popular_language(languages: list, popularity: list):
    ...
    print("The most popular langauges are currently: \n")
